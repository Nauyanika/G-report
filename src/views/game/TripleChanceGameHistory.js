...
import MaterialTable, { MTableToolbar, MTableHeader,MTablePagination,MTableBodyRow,MTableBody} from 'material-table'
...
function TripleChanceGameHistory() {
      ...
      <MaterialTable
        ...
        options={{
          ...
          pageSize: 20,
            ...
            headerStyle:{background:"rgb(179 179 179)",fontStyle:'italic', border:'1px solid black',
               } , 
  ...
  textAlign:"center",
          ...
          rowStyle:{border:'1px solid black'},
              rowStyle:(data,index)=>index%2==0?{background:"#cfe2ff",}:null,
              cellStyle:{border:'1px solid black',alignItems:"center" , },paging: true,
     }}
        components={{
          Toolbar: props => (
              <div style={{ background:"rgb(179 179 179)",borderSpacing: "5px" }}>
                  <MTableToolbar {...props} />
              </div>
          ),
          // Pagination: props => (
...
export default TripleChanceGameHistory;
