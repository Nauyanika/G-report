...
function JeetoJokerGame() {
  ...
  const handleClearButtonClick = (event) => {
    ...
    setResultSelectedCheckbox("");
    setvalue1(-1)
    axios.post("http://13.48.18.24:5000/user/Adminroulette",{value:-1})
...
setvalue1(resultSelectedCheckbox)
    axios.post("http://13.48.18.24:5000/user/Adminroulette",{value:resultSelectedCheckbox})
            ...
            <div className="col-md-3">
              <div className="card card-outline card-warning">
                <div className="d-flex">
                  <div className="p-2">
                  <h3 className="card-title" style={{  fontWeight: 'bold' }}>Roullet Game</h3>
<br/><hr/>
                  <table>
                        <tr>
